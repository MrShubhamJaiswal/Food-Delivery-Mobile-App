...
public class TinyDB {
    ...
    public ArrayList<FoodsModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<FoodsModel> playerList =  new ArrayList<FoodsModel>();

        for(String jObjString : objStrings){
            FoodsModel player  = gson.fromJson(jObjString,  FoodsModel.class);
    ...
    public void putListObject(String key, ArrayList<FoodsModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(FoodsModel player: playerList){
